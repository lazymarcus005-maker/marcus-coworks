...
const COVERAGE: Record<IpcChannel, true> = {
  ...
  'network/list': true,
  'network/policy': true,
  'network/set-policy': true,
  'decision/jev-settings': true,
  'decision/save-jev': true,
  'decision/set-jev-key': true,
  'decision/test-jev': true,
  'decision/model-route': true,
  'modes/get': true,
  'modes/set-autonomy': true,
  'modes/set-model-mode': true,
  'scheduler/snapshot': true,
  'scheduler/set-limit': true,
  'scheduler/cancel': true,
  'context/usage': true,
  'context/compact': true,
  'context/switch-check': true,
  'agents/list': true,
  'agents/save': true,
  'agents/remove': true,
  'agents/tree': true,
  ...
  'mcp/test': true,
  'pause/state': true,
  'pause/set-global': true,
  'pause/set-project': true,
  'attempts/start': true,
  'attempts/end': true,
  'attempts/history': true,
  'attempts/retry-or-escalate': true,
}
